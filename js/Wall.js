...
import { randomNumBeetween } from "./util.js";
...
export default class Wall {
  constructor(config) {
    ...
    this.gapY = randomNumBeetween(App.height * 0.2, App.height * 0.7);
    this.x = App.width;
    this.y1 = -this.height + randomNumBeetween(30, App.height - this.gapY - 30);
    this.y2 = this.y1 + this.height + this.gapY;

    this.vx = -6;

    this.generatedNext = false;
    this.gapNextX = App.width * randomNumBeetween(0.6, 0.8);
